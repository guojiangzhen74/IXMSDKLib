...
//          footView.backgroundColor =[UIColor whiteColor];
        ...
        [checkBtn setImage:[UIImage imageNamed:@"ixm_empty_check"] forState:UIControlStateNormal];
        [checkBtn setImage:[UIImage imageNamed:@"ixm_checked"] forState:UIControlStateSelected];
        ...
        [titles enumerateObjectsUsingBlock:^(NSString  *str, NSUInteger idx, BOOL * _Nonnull stop) {
            ...
            [imageview setImage:[UIImage imageNamed:@"hcclose"]];
