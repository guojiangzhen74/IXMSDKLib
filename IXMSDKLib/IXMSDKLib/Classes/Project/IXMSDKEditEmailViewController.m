...
@interface IXMSDKEditEmailViewController ()<UITableViewDelegate,UITableViewDataSource>{
...
@implementation IXMSDKEditEmailViewController
...
- (void)viewDidLoad {
    ...
    placeholderArray=@[@"请输入新的Email",@"请输入密码",@"请输入验证码"];
...
-(void)sendAction{
    ...
    if ([userParamsModel.email rangeOfString:@"@"].length==0||[userParamsModel.email rangeOfString:@".com"].length==0) {
